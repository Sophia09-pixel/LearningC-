    ...
    class Program
    {
...

        {
            ...
            if (Data == 15)
            {
                ...
                Console.WriteLine($"O total de caixinha foi de{totcx.ToString("F2", CultureInfo.InvariantCulture)}");

                double totaldi = totcx + TotalDi;
                ...
                double totalar = totcxar + TotalArlete;
                ...
                double totalje = totcxje + TotalJessica;
